...
def register(
    ...
    @mcp.tool(
        ...
        description=(
            ...
            "valueFrom says where that step's value comes from instead of "
            "giving it in params: {'param': 'email'} takes it from this flow's "
            "parameters, {'secret': {'name': 'x', 'key': 'password'}} from a "
            "secret you never see. Exactly one source, and you may not also "
            "give the value in params. There is no {{templating}}.\n\n"
